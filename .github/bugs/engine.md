...
- **Status:** ⏸️ Deferred — **scheduled 2026-08-07 as Phase 6 Chunk H.1** per [`phase6-plan.md`](../plans/phase6-plan.md). Pure cleanup, no functional bug. Surfaced 2026-05-23 during docs-cleanup Pass D1.5 sweep.
