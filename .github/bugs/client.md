...
- **Status:** ⚠️ Open — surfaced 2026-09-16 while making the router hash-driven (ADR-017 teardown work); guard kept as-is there because the leak gate does not exercise the race.
