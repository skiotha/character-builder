...
- **Class methods get a brief JSDoc line when the name alone does not tell what the method guarantees** (lifecycle hooks, coalescing / scheduling helpers, abstract entry points). One line is enough; skip trivial accessors.
