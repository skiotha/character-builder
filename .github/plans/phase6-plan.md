...
3a. **Resolve per-slot `SpecialAttack` / `Reaction` inheritance at
    ...
    amendment block and [authoring-effects.md §10](../../docs/authoring-effects.md#L0).
